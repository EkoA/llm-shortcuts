 ...
 */
export var SecurityVulnerability;
(function (SecurityVulnerability) {
    SecurityVulnerability["PROMPT_INJECTION"] = "prompt_injection";
    SecurityVulnerability["XSS"] = "xss";
    SecurityVulnerability["DATA_EXPOSURE"] = "data_exposure";
    SecurityVulnerability["UNSAFE_EVAL"] = "unsafe_eval";
    SecurityVulnerability["UNSAFE_INLINE"] = "unsafe_inline";
    SecurityVulnerability["CSRF"] = "csrf";
    SecurityVulnerability["CLICKJACKING"] = "clickjacking";
    SecurityVulnerability["DATA_LEAKAGE"] = "data_leakage";
...
export class SecurityAuditManager {
     ...
     * Check for prompt injection vulnerabilities
     */
    checkPromptInjectionVulnerabilities() {
        const vulnerabilities = [];
        const warnings = [];
        const recommendations = [];
     ...
     * Check for unsafe eval usage
     */
    checkUnsafeEvalVulnerabilities() {
        const vulnerabilities = [];
        const warnings = [];
        const recommendations = [];
     ...
     * Check for clickjacking vulnerabilities
     */
    checkClickjackingVulnerabilities() {
        const vulnerabilities = [];
        const warnings = [];
        const recommendations = [];
     ...
     * Check for data leakage vulnerabilities
     */
    checkDataLeakageVulnerabilities() {
        const vulnerabilities = [];
        const warnings = [];
        const recommendations = [];
     ...
     */
    containsPromptInjectionPatterns(text) {
     ...
     */
    generateSecurityReport(auditResult) {
 ...
 * Generate security report
 */
export function generateSecurityReport(auditResult) {
